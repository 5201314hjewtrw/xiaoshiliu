...
CREATE TABLE IF NOT EXISTS `posts` (
  ...
  `category_id` int(11) DEFAULT NULL COMMENT '分类ID（可选）',
  ...
  `visibility` enum('public','private','mutual_followers') NOT NULL DEFAULT 'public' COMMENT '可见性设置：public-公开，private-私密，mutual_followers-仅互关好友可见',
  PRIMARY KEY (`id`),
  KEY `idx_user_id` (`user_id`),
